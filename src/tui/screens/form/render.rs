    ...
    match ct {
        CredentialType::Login => {
            ...
            let password_row = text_input::render_password_input_with_buttons(
                ...
                state.fields.password.as_ref().map(|p| p.expose(|s| s.to_string())).unwrap_or_default().as_str(),
                focused == 4,
                pw_error.is_some(),
        ...
        CredentialType::Api => {
            ...
            let secret_row = text_input::render_password_input_with_buttons(
                ...
                state.fields.secret_key.as_ref().map(|k| k.expose(|s| s.to_string())).unwrap_or_default().as_str(),
                focused == 4,
                false,
        ...
        CredentialType::Ssh => {
            ...
            lines.extend(text_input::render_password_input_with_buttons(
                ...
                state.fields.private_key.as_ref().map(|k| k.expose(|s| s.to_string())).unwrap_or_default().as_str(),
                focused == 4,
                false,
            ...
            lines.extend(text_input::render_password_input_with_buttons(
                ...
                state.fields.passphrase.as_ref().map(|p| p.expose(|s| s.to_string())).unwrap_or_default().as_str(),
                focused == 5,
                false,
