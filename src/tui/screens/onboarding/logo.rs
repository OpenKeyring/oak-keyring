...
const LINE0: [Color; 44] = [
    ...
    Color::Rgb(7, 222, 153),
    Color::Rgb(8, 225, 149),
    Color::Rgb(10, 228, 145),
    Color::Rgb(12, 230, 141),
    Color::Rgb(13, 233, 136),
    Color::Rgb(15, 235, 132),
    Color::Rgb(17, 237, 128),
    Color::Rgb(20, 239, 124),
    Color::Rgb(22, 241, 119),
    Color::Rgb(24, 243, 115),
    Color::Rgb(27, 245, 111),
    Color::Rgb(29, 246, 107),
    Color::Rgb(32, 248, 103),
    Color::Rgb(35, 249, 98),
    Color::Rgb(38, 250, 94),
    Color::Rgb(41, 251, 90),
    Color::Rgb(44, 252, 86),
